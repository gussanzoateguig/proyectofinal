    ...
    BootstrapTable.prototype.initToolbar = function() {
            ...
            $.each(this.columns, function(i, column) {
                ...
                if (column.switchable) {
                    html.push(sprintf("<li class='dropdown-item '>" +
                        '<div class="checkbox">' +
                        '<input type="checkbox" data-field="%s" value="%s"%s><label> %s </label>' +
        ...
        if (this.options.search) {
            ...
            html.push(
                ...
                sprintf('<input class="form-control form-control-sm' +
    ...
    BootstrapTable.prototype.initPagination = function() {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                '<ul class="pagination pagination-sm' + sprintf(' pagination-%s', this.options.iconSize) + '">',
